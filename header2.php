...
<img src="images/222.png" height="30" width="120">
 ...
 <li>
     <a href="contact2.php"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> ติดต่อเรา</a>
 </li>	
...
<li><p class="navbar-text"> <i class='glyphicon glyphicon-user'></i> ยินดีต้อนรับ : คุณเหมหงส์  อาจณรงค์</li>
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="package_list.php">ข้อมูลแพ็คเกจ</a></li>
		 <li><a href="type_list.php">ข้อมูลประเภทรถ</a></li>
		  <li><a href="time_list.php">ข้อมูลเวลาล้าง</a></li>
